          ...
          {!isTablet && (
            <Grid.Col span={6}>
              <Box
                ...
                style={{
                  background:
                    "linear-gradient(135deg, #40c057 0%, #339af0 50%, #7950f2 100%)",
                  position: "relative",
                  display: "flex",
                  alignItems: "center",
                  ...
                  <Stack gap="xl">
                    <Box>
                      ...
                      <Text size="lg" c="white" opacity={0.9}>
                        Join thousands of successful brands and transform your
                        marketing with AI-powered content.
                      </Text>
                    </Box>
                      ...
                      <Paper bg="violet.0" p="md" mb="xl" radius="md">
                        <Group gap="xs" mb="xs">
                          ...
                          <Text size="sm" fw={600} c="violet.7">
                            Why Choose BrandBanda?
                          </Text>
                        </Group>
                        <Group gap={4}>
                          {["AI-Powered", "Split Testing", "Analytics"].map(
                            (item) => (
                              <Badge
                                key={item}
                                size="sm"
