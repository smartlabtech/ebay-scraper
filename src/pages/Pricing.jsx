  ...
  const plans = [
    {
      ...
      features: [
        {
          text: `${SUBSCRIPTION_PLAN_DETAILS[0].credits.toLocaleString()} AI Credits/month`,
          included: true
        },
        {
          text: `~${Math.floor(
            500 / TOKEN_COSTS.BRAND_MESSAGE
          )} Brand Messages`,
          included: true
        },
        {
          text: `~${Math.floor(
            500 / TOKEN_COSTS.COPY_GENERATION
          )} Copy Generations`,
          included: true
        },
    ...
    },
    {
      ...
      features: [
        {
          text: `${SUBSCRIPTION_PLAN_DETAILS[1].credits.toLocaleString()} AI Credits/month`,
          included: true
        },
        {
          text: `~${Math.floor(
            5000 / TOKEN_COSTS.BRAND_MESSAGE
          )} Brand Messages`,
          included: true
        },
        {
          text: `~${Math.floor(
            5000 / TOKEN_COSTS.COPY_GENERATION
          )} Copy Generations`,
          included: true
        },
    ...
    },
    {
      ...
      features: [
        {
          text: `${SUBSCRIPTION_PLAN_DETAILS[2].credits.toLocaleString()} AI Credits/month`,
          included: true
        },
        {
          text: `~${Math.floor(
            20000 / TOKEN_COSTS.BRAND_MESSAGE
          )} Brand Messages`,
          included: true
        },
        {
          text: `~${Math.floor(
            20000 / TOKEN_COSTS.COPY_GENERATION
          )} Copy Generations`,
          included: true
        },
    ...
    },
    {
      ...
      features: [
        {
          text: `${SUBSCRIPTION_PLAN_DETAILS[3].credits.toLocaleString()} AI Credits/month`,
          included: true
        },
        {
          text: `~${Math.floor(
            100000 / TOKEN_COSTS.BRAND_MESSAGE
          )} Brand Messages`,
          included: true
        },
        {text: "Unlimited Projects", included: true},
                  ...
                  <Card
                    ...
                    style={{
                      borderColor: plan.popular
                        ? `var(--mantine-color-${plan.color}-6)`
                        : undefined,
            ...
            <Card shadow="md" radius="lg" p="xl" withBorder>
              <Stack align="center" ta="center">
                ...
                <Text size="lg" c="dimmed" maw={600}>
                  Every AI-powered action consumes credits. Purchase a plan
                ...
                >
                  <Text size="sm">
                    <strong>Credit Rollover:</strong> Unused credits roll over
                    to the next month for paid plans (up to 3 months) when you
                    pay on time. Free plan credits don't roll over.
                  </Text>
                </Alert>
              </Stack>
            </Card>
