        ...
        <Paper shadow="sm" p="xl" radius="md">
          <Stack gap="xl">
            ...
            <section>
              ...
              <Text mb="md">
                By accessing and using BrandBanda ("the Service"), you agree to
            ...
            <section>
              ...
              <Text mb="md">
                BrandBanda provides AI-powered brand messaging and content
                creation services. Our platform enables users to:
              </Text>
              <List mb="md">
                <List.Item>
                  Generate brand messages using artificial intelligence
                </List.Item>
                <List.Item>
            ...
            <section>
              ...
              <Text mb="md">
                Content generated using BrandBanda remains your property.
            ...
            <section>
              ...
              <Text mb="md">
                ...
                effect at the end of the current billing period. We do not
                provide refunds for partial months or unused services.
              </Text>
            </section>
            ...
            <section>
              ...
              <Text mb="md">
                BrandBanda is provided "as is" without warranties of any kind.
            ...
            <section>
              ...
              <Text mb="md">
                Your use of BrandBanda is also governed by our Privacy Policy.
